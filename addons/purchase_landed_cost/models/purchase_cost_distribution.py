...
class PurchaseCostDistribution(models.Model):
    ...
    def _compute_total_purchase(self):
        for x in self.cost_lines:
            print "x.total_amount: ",x.total_amount
        self.total_purchase = sum([x.total_amount for x in self.cost_lines])
        print "self.total_purchase: ",self.total_purchase
#        aaa
    ...
    total_purchase = fields.Float(
        ...
        digits=(12,3), string='Total purchase')
    ...
    total_expense = fields.Float(
        ...
        digits=(12,3), string='Total expenses')
        ...
        for distribution in self:
            ...
            for line in distribution.cost_lines:
                ...
                for expense in distribution.expense_lines:
                    ...
                    print "multiplier divisor: ",multiplier, divisor
...
#            self.move_id and self.move_id.get_price_unit(self.move_id) or 0.0)
        ...
        qty_default_uom = uom_obj._compute_qty_obj(self.purchase_line_id.product_uom, self.purchase_line_id.product_qty, self.purchase_line_id.product_id.uom_id)
